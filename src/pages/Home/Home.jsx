...
function Home({ filterType, onBookSelectFromSearch }) {
    ...
    const getRecentBooks = () => {
        return [...Data].sort((a, b) => new Date(b.date) - new Date(a.date)).slice(0, 3)
    }
    ...
    const getDailyRandomBooks = () => {
        ...
        // Retourner 5 livres (ou moins si pas assez de livres)
                    ...
                    <section id="Daily-discoveries">
                        <div className="Title-Section">
                            ...
                            <p className="subtitle">
                                Quelques livres sélectionnés pour vous aujourd'hui
                            </p>
                        </div>
        ...
        <section className="Section-Home">
            <div className="Home">
                ...
                <div className="Tags-Navigation-Container">
                    <TagsNavigation activeTag={activeTag} onTagClick={handleTagClick} />
                </div>
